...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.BudgetMonth", b =>
                {
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.BusinessTransactionActivity", b =>
                {
                    b.Property<long>("BusinessTransactionActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.MonthYear", b =>
                {
                    b.Property<long>("MonthYearId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.Reference.AccountType", b =>
                {
                    b.Property<long>("AccountTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.Transaction", b =>
                {
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.TransactionBatch", b =>
                {
                    b.Property<long>("TransactionBatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.TransactionCategory", b =>
                {
                    b.Property<long>("TransactionCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.User", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.UserParameter", b =>
                {
                    b.Property<long>("UserParameterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("UserParameterId"));
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.Account", b =>
                {
                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.Reference.AccountType", "AccountType")
                        .WithMany()
                        .HasForeignKey("AccountTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.BusinessTransactionActivity", "BusinessTransactionActivity")
                        .WithMany()
                        .HasForeignKey("BusinessTransactionActivityId");

                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.BudgetMonth", b =>
                {
                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.MonthYear", "MonthYear")
                        .WithMany()
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.BusinessTransactionActivity", b =>
                {
                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("BudgetR.Simplified.Server.Domain.Entities.BusinessTransactionActivity", "UserId");
            ...
            modelBuilder.Entity("BudgetR.Simplified.Server.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.BudgetMonth", "BudgetMonth")
                        .WithMany()
                    ...
                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.TransactionBatch", "TransactionBatch")
                        .WithMany("Transactions")
                        .HasForeignKey("TransactionBatchId");

                    b.HasOne("BudgetR.Simplified.Server.Domain.Entities.TransactionCategory", "TransactionCategory")
                        .WithMany()
