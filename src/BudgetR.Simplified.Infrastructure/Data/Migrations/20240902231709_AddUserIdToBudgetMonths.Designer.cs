...
namespace BudgetR.Simplified.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240902231709_AddUserIdToBudgetMonths")]
    partial class AddUserIdToBudgetMonths
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetR.Simplified.Domain.Entities.BusinessTransactionActivity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 9, 2, 17, 17, 9, 252, DateTimeKind.Local).AddTicks(3839),
